...
const BlogBuildAndSurvive: NextPage<PageData> = ({ dataProps }) => {
    ...
    return (
        <div className="bg-pageBg/90 overflow-x-hidden">
            ...
            <BlogContentWrapper dataProps={dataProps} fetchMoreQueryString="Build and Survive" />
        </div>
    );
};

export default BlogBuildAndSurvive;
...
export async function getStaticProps() {
    const {
        ...
        query: gql`
            query DevBlog {
                devBlogs(filters: { tag: { eq: "Build and Survive" } }, sort: "date:desc") {
                    data {
                        attributes {
                            mainPageHeaderTitle
                            title
